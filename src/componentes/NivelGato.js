...
class NivelGato extends Phaser.Scene{


constructor(){

super('NivelGato');      // Constructor que almacenara un key o identificador de la escena, se encarga de enviar los parametros
...
this.load.image('gato','./imagenes/gatofondo.jpg');
...
this.load.audio('musicaescena', './musica/CatMusic.mp3');
...
export default NivelGato;             // Exporta la escena.