...
class Escena extends Phaser.Scene {
  ...
  constructor() {
    super('Alien');      // Constructor que almacenara un key o identificador de la escena, se encarga de enviar los parametros
  }
  ...
  preload() {
    ...
    this.load.image('AlienAzul', './imagenes/AlienAzul.png');
    this.load.image('AlienRojo', './imagenes/AlienRojo.png');
  ...
  create() {
    ...
    this.bloques = this.physics.add.staticGroup({
      key: ['AlienAzul', 'AlienRojo', 'AlienVerde'],   // Se crea un array que almacenara y ademas ubicara todos los bloques en la pantalla.
      frameQuantity: 18, //Cantidad maxima de bloques de cada color
      gridAlign: {
        width: 9, //Cantidad maxima de bloques por fila.
        ...
        cellWidth: 130, //Distancia de ancho entre cada bloque
        cellHeight: 95, //Distancia de alto entre cada bloque
        x: 180, //Posicion de los bloques en X
