...
this.load.image('fondo','./imagenes/fondoLofi.png');
this.load.image('barra','./imagenes/barraLofi.png');
this.load.image('pelota','./imagenes/pelotaLofi.png');
this.load.image('bloqueazul','./imagenes/bloqueazulLofi.png');
this.load.image('bloquerojo','./imagenes/bloquerojoLofi.png');
this.load.image('bloqueverde','./imagenes/bloqueverde Lofi.png');
this.load.audio('musicaescena', './musica/Magical Forest.ogg');
...
this.bloques = this.physics.add.staticGroup({
    key: ['bloquerojo'],   // Se crea un array que almacenara y ademas ubicara todos los bloques en la pantalla.
    frameQuantity: 13,
    gridAlign: { 
    width: 10, 
    height: 1, 
